...
def dice_create():
    ...
    names = ['F1.png','F2.png','F3.png','F4.png','F5.png','F6.png']
    
    for di in names:
        
        dice = Image.open(f"images/{di}")
...
img1 = Image.open('images/snake_ladder.png')

resized_img = img1.resize((700,700), Image.Resampling.LANCZOS)
